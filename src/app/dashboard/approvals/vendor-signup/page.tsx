...
export default function VendorSignUpApproval() {
  ...
  return (
    <>
      <div>
        <h4 className="text-[2.5rem] mb-6">Approve Vendor - Signup</h4>

        <div className="grid grid-cols-12">
          {/* <Image src={""} alt="profile-picture"  className="w-full aspect-square col-span-4" />
          <div className="col-span-1"></div> */}
          <div className="w-full col-span-6 flex flex-col justify-between h-fit gap-5">
            <h4 className="text-[2rem]">Company Details</h4>
        ...
        <div className="flex justify-end items-center gap-[2rem] mt-[3rem]">
          {data?.status == "Pending" ? (
            <>
              ...
              <button
                className="bg-[#FF3131] inline-block p-2 rounded-md text-white"
                onClick={() => {
                  manageApproval(
                    searchParams.get("id") as string,
                    false,
